...
package org.geometerplus.zlibrary.ui.android.aplicatii.romanesti_molitfelnic.view;
...
import org.geometerplus.zlibrary.ui.android.aplicatii.romanesti_molitfelnic.view.animation.*;
...
public class ZLAndroidWidget extends MainView implements ZLViewWidget, View.OnLongClickListener {
	...
	protected void onDraw(final Canvas canvas) {
		...
		if (context instanceof FBReaderMolitfelnic) {
			((FBReaderMolitfelnic)context).createWakeLock();
		} else {
			System.err.println("A surprise: view's context is not an FBReaderMolitfelnic");
		}
		super.onDraw(canvas);
